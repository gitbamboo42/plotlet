...
def chart_chord_ribbon_flat():
    ...
    c.add_chord_ribbon(data=df, mapping=aes(x1_start="a0", x1_end="a1", x2_start="b0", x2_end="b1"),
...
def chart_chord_ribbon_color():
    ...
    df = {"a0": [0.0, 1.0, 2.0], "a1": [0.8, 1.8, 2.8],
      ...
      "grp": ["p", "q", "p"]}
    c.add_chord_ribbon(data=df, mapping=aes(x1_start="a0", x1_end="a1", x2_start="b0", x2_end="b1", color="grp"), palette={"p": "#C44E52", "q": "#8172B3"},
